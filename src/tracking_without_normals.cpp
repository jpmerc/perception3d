...
void printToPCLViewer(){
    ...
    pcl::visualization::PointCloudColorHandlerCustom<PointT> yellow_color(tracked_object, 255, 255, 102);
    pclViewer->addPointCloud<PointT>(tracked_object,yellow_color,"tracked cloud");
